...
nous avons pu verifier que le calcul n’etait pas altere.
	...
	\section{Organisation interne et affectation des taches}
		...
		Cette phase a constitu´e l’´etape critique du projet, avec d’une part la d´ecision de coder l’interface graphique
et d’autre part l’int´egration de tous les modules. Lors de cette phase, les modules ont connu leurs derni`eres ´evolutions.
