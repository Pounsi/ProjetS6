...
\section{AUTRES ASPECTS DU PROJET}
		...
		\includepdf[scale=0.5]{organigramme.pdf}
...
Détails des modules:\\
		...
		\includepdf[scale=0.5]{tabcout.pdf} 
...
De plus, toute l'equipe le maitrise, entrainant ainsi une diminution des couts liée a un eventuel temps de formation.
